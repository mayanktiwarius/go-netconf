...
func main() {
	...
	//reply, err := s.Exec(netconf.RawMethod("<get-config format=\"json\"> <source><running/></source> <filter type=\"subtree\"> <configuration> <protocols> <mld/> </protocols></configuration> </filter> </get-config>"))
	reply, err := s.Exec(netconf.RawMethod("<get-configuration database=\"committed\" format=\"json\"><configuration><protocols><mld/></protocols></configuration></get-configuration>"))
